            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="profile.jsp"><span class ="fa fa-bar-chart"></span>Learn With Mayank <span class="sr-only">(current)</span></a>
                    </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id ="edit-profile-button1" class="btn btn-primary">Edit</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
     ...
     $('#edit-profile-button1').click(function () {
     if (editStatus == false)
       {
