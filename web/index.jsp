        ...
        <div class="container-fluid-0 m-0 ">
            <div class="jumbotron primary-background text-white banner-background">
                <div class="container">
                    ...
                    <p> Welcome To Technical Blog , A World Of Technology A programming language is a system of notation for writing computer programs.Most programming languages are text-based formal languages, but they may also be graphical. They are a kind of computer language. </p>
                    ...
                    <button class="btn btn-outline-light btn-lg"> <span class="fa fa-send"></span> Start ! Its Free </button>
